...
@Component({
    selector: 'lib-sandbox-prime-designer',
    templateUrl: './prime-designer.component.html',
    styleUrls: ['./prime-designer-app.scss', './prime-designer.component.scss'],
})

export class LibSandboxPrimeDesignerComponent {
    ...
    getGlobalFilterValue($event: Event) {
